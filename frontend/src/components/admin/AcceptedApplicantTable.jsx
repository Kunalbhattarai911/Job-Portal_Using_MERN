...
const AcceptedApplicantTable = () => {
    ...
    // Filter applicants based on search term (name, email, and phone number)
    ...
    return (
        <div>
            ...
            />
            <Table>
                <TableCaption>A list of accepted applicants</TableCaption>
                <TableHeader>
                    <TableRow>
                        ...
                        filteredApplicants.length > 0 ? (
                            filteredApplicants.map((item) => (
                                <TableRow key={item._id}>
                                    ...
                                    <TableCell>{item.status || 'Accepted'}</TableCell>
                                </TableRow>
                            ))
                        ) : (
                            <TableRow>
                                <TableCell colSpan="6">No accepted applicants found.</TableCell>
                            </TableRow>
                        )
                    }
                </TableBody>
...
export default AcceptedApplicantTable;
